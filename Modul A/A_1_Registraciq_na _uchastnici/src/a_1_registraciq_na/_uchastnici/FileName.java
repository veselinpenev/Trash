 ...
 * @author Krasen
 */
public class FileName extends javax.swing.JDialog {

    /**
     * Creates new form FileName
     */
    public FileName(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FileName dialog = new FileName(new javax.swing.JFrame(), true);
